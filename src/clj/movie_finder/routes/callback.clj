...
{:attachment {:type "template",
              :payload {:template_type "list",
                        :elements [{:title "The Shawshank Redemption",
                                    :subtitle "Framed in the 1940s for the double murder of his wife and her lover, upstanding banker Andy Dufresne begins a new life at the Shawshank prison, where he puts his accounting skills to work for an amoral warden. During his long stretch in prison, Dufresne comes to be admired by the other inmates -- including an older prisoner named Red -- for his integrity and unquenchable sense of hope.",
                                    :image_url "/9O7gLzmreU0nGkIB6K3BsJbzvNv.jpg",
                                    ...
                                    :buttons [{:type "web_url",
                                               ...
                                               :url "http://google.com"}]}
                                   {:title "Whiplash",
                                    :subtitle "Under the direction of a ruthless instructor, a talented young drummer begins to pursue perfection at any cost, even his humanity.",
                                    :image_url "/lIv1QinFqz4dlp5U4lQ6HaiskOZ.jpg",
                                    :default_action {:type "web_url",
                                                     :title nil,
                                                     :url "http://google.com"},
                                    :buttons [{:type "web_url",
                                               ...
                                               :url "http://google.com"}]}
                                   {:title "The Godfather",
                                    :subtitle "Spanning the years 1945 to 1955, a chronicle of the fictional Italian-American Corleone crime family. When organized crime family patriarch, Vito Corleone barely survives an attempt on his life, his youngest son, Michael steps in to take care of the would-be killers, launching a campaign of bloody revenge.",
                                    :image_url "/w7t3f2XhtmLF6z9RcxQcexRSZrg.jpg",
                                    :default_action {:type "web_url",
                                                     :title nil,
                                                     :url "http://google.com"},
                                    :buttons [{:type "web_url",
                                               ...
                                               :url "http://google.com"}]}
                                   {:title "Piper",
                                    :subtitle "The short centers on a young sandpiper, the eponymous Piper, who is afraid of the water. She meets a young hermit crab who \"teaches her the way of the waves\".",
                                    :image_url "/jLRllZsubY8UWpeMyDLVXdRyEWi.jpg",
                                    :default_action {:type "web_url",
                                                     :title nil,
                                                     :url "http://google.com"},
                                    :buttons [{:type "web_url",
...
;;(post-messenger sender-id {:attachment (bots/make-list-template (map #(bots/map->Movie %) (:results (async/<!! (api/top-rated-movies)))))}))
